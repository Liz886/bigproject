...
class SudokuUI:
    ...
    def create_widgets(self):
        ...
        # 难度选择
        ttk.Label(left_control, text="难度:").pack(side=tk.LEFT, padx=(0, 5))
        ...
        # 功能按钮
        ttk.Button(right_control, text="检查", command=self.check_board).pack(side=tk.LEFT, padx=5)
        ttk.Button(right_control, text="清空", command=self.clear_board).pack(side=tk.LEFT, padx=5)
        ttk.Button(right_control, text="求解", command=self.solve_sudoku).pack(side=tk.LEFT, padx=5)
