...
class SudokuUI:
    ...
    def create_widgets(self):
        ...
        for i in range(9):
            ...
            for j in range(9):
                ...
                entry.grid(row=i, column=j, ipady=5, padx=(1, 1), pady=(1, 1))
    ...
    def on_focus(self, event, i, j):
        ...
        # 高亮当前单元格
        event.widget.configure(foreground="#e91e63")
            ...
            for i in range(9):
                for j in range(9):
                    ...
                    if value != 0:
                        ...
                        self.cells[i][j].insert(0, str(value))
                        # 设置生成的数字为不可修改
                        self.cells[i][j].configure(state="readonly", foreground="#1976d2")
                    else:
                        # 设置空白单元格为可修改
                        self.cells[i][j].configure(state="normal", foreground="black")
