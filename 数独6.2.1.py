...
class SudokuUI:
    def __init__(self, root):
        ...
        self.is_puzzle_generated = False  # 标记是否为生成的谜题
    ...
    def set_board(self, board, is_solution=False):
        """将求解结果设置到输入框"""
        for i in range(9):
            for j in range(9):
                value = board[i][j]
                ...
                if value != 0:
                    ...
                    if is_solution:
                        ...
                        entry.configure(foreground="#2c3e50")  # 题目数字为深蓝黑
                else:
                    entry.configure(foreground="black")   # 空格为黑色
    ...
    def solve_sudoku(self):
        ...
        if solve_result:
            self.set_board(solver.board, is_solution=True)
    ...
    def clear_board(self):
        ...
        self.is_puzzle_generated = False
    ...
    def recognize_sudoku(self, file_path):
        ...
        try:
            ...
            # 更新UI
            self.root.after(0, lambda: self.set_board(board, is_solution=False))
