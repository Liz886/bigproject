...
class SudokuUI:
    ...
    def _preprocess_cell(self, cell):
        ...
        # 添加边框以提高识别率
        digit = cv2.copyMakeBorder(digit, 5, cv2.BORDER_CONSTANT, value=0)
    ...
    def _recognize_digit(self, digit_img):
        """使用Tesseract识别单个数字"""
        # 配置Tesseract
        # 在导入pytesseract后添加以下代码
        import pytesseract
        pytesseract.pytesseract.tesseract_cmd = r'D:\Tesseract\tesseract.exe'  # 注意使用原始字符串或双反斜杠
